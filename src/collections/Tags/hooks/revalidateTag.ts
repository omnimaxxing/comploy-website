...
import type { Tag, Plugin } from '@/payload-types'

export const revalidateTag: CollectionAfterChangeHook<Tag> = async ({
	doc,
	previousDoc,
	req: { payload },
}) => {
	...
	payload.logger.info(`Revalidating tag paths: ${path} and ${path2}`)
