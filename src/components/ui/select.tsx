...
>(({ children, className, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      ref={ref}
      {...props}
      style={{ overflowY: 'auto' }} // Ensure the content itself can scroll, reducing the impact on the body
    >
